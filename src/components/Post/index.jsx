export default function Post({...props}) {
    return (
        <div className={"post sm:w-full lg:w-full md:w-[45%] opacity-0 flex flex-col items-start gap-1 " + props.className}>
            ...
            <div className="font-ptSans flex gap-2 text-base text-jet dark:text-white">
                <span className="rounded-full -moz-h-full min-w-[2px] bg-jet dark:bg-white"></span>
